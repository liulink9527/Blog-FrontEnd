      ...
      <el-col :span="6">
        <el-card>
          <div class="card-icon-container">
            <i
              class="iconfont el-icon-myfangwenliang"
              style="color: #40c9c6" />
          </div>
          <div class="card-desc">
      ...
      <el-col :span="16">
        <el-card>
          ...
          <div
            ...
            <v-chart :options="userAreaMap"></v-chart>
          </div>
        </el-card>
      </el-col>
  ...
  methods: {
    getData() {
      this.axios.get('/api/admin').then(({ data }) => {
        ...
        this.articleStatisticsList = data.data.articleStatisticsDTOList

        if (data.data.uniqueViewDTOList !== null) {
          data.data.uniqueViewDTOList.forEach((item) => {
            this.oneWeekViewsCount.xAxis.data.push(item.day)
            this.oneWeekViewsCount.series[0].data.push(item.viewsCount)
          })
        }
